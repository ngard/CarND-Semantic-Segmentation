...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes, keep_prob=tf.constant(1.0), enable_extra_dropout=False):
    ...
    kernel_initializer_function = tf.truncated_normal_initializer(stddev=1e-2)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        get_batches_fn = helper.gen_batch_function(os.path.join(data_dir, 'data_road/training'), image_shape, enable_augmentation=True)

        # OPTIONAL: Augment Images for better results
        #  https://datascience.stackexchange.com/questions/5224/how-to-prepare-augment-images-for-neural-network
        # A simple augmentation is implemented in helper.gen_batch_function() as upper
